    ...
    <div class="container-fluid main-body">
        <div class="header-container d-flex flex-row"> 
            ...
            <div class="user-container ms-auto">
                <a id="profile-button" class="btn btn-light d-flex align-items-center" href="/src/components/personnel_user/profile.html" role="button" data-page="personnel_user/profile">
